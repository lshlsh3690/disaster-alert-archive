...
export const METROS = [
  ...
  "전남광주통합특별시", // 2026-07-01 광주광역시·전라남도 통합 개편. 옛 데이터도 모두 이 코드로
  // 이관 완료(V111)되어 더 이상 조회되지 않으므로 "광주광역시"/"전라남도"는 목록에서 제외.
] as const;
...
export const METRO_COORDS: Record<Metro, { lat: number; lng: number }> = {
  ...
  충청남도: { lat: 36.5, lng: 126.9 },
  전북특별자치도: { lat: 35.82, lng: 127.15 },
  경상북도: { lat: 36.49, lng: 128.73 },
  경상남도: { lat: 35.23, lng: 128.68 },
  제주특별자치도: { lat: 33.489, lng: 126.4983 },

  전남광주통합특별시: { lat: 34.9895, lng: 126.8728 },
};
...
const REGION_ALIASES: Record<string, Metro> = {
  ...
  광주광역시: "전남광주통합특별시", // 2026-07-01 개편 이전 표기
  전라남도: "전남광주통합특별시", // 2026-07-01 개편 이전 표기
};
