...
export const WIDGET_LIBRARY: LibItem[] = [
  ...
  { id: "stacked",    kind: "stacked", title: "월별 유형별 발생",    desc: "유형별 월간 누적 발생 추이", help: "최근 12개월간 월별 재난문자를 유형별로 누적해 보여줍니다. 계절별 재난 패턴 파악에 유용합니다. 필터 기간이 한 달 미만이면 일별 데이터로 자동 전환됩니다.",                                                 defaultSpan: 6,  icon: "🪜", variants: [{ key: "donut", label: "도넛" }, { key: "hbar", label: "가로막대" }, { key: "bar", label: "세로막대" }] },
