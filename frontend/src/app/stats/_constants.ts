...
export const WIDGET_LIBRARY: LibItem[] = [
  { id: "type-donut", kind: "donut",   title: "재난 유형 분포",     desc: "유형별 점유율 도넛 차트",    help: "현재 필터 기간의 재난문자를 유형별(폭염·태풍·산불 등)로 분류해 점유율을 보여줍니다. 유형을 클릭하면 모든 차트가 해당 유형으로 연동됩니다.",                                                             defaultSpan: 6,  icon: "🍩", variants: [{ key: "donut", label: "도넛" }, { key: "hbar", label: "가로막대" }, { key: "vbar", label: "세로막대" }] },
  ...
  { id: "daily-line", kind: "line",    title: "일별 발생 추이",      desc: "날짜별 발생 건수 시계열",    help: "날짜별 재난문자 발생 건수를 그래프로 보여줍니다. 8일 이상 데이터에서는 하단 범위 선택 바를 드래그해 특정 구간을 확대할 수 있습니다.",                                                     defaultSpan: 12, icon: "📈", variants: [{ key: "line", label: "꺾은선" }, { key: "bar", label: "막대" }] },
  ...
  { id: "stacked",    kind: "stacked", title: "월별 유형별 발생",    desc: "유형별 월간 누적 발생 추이", help: "최근 12개월간 월별 재난문자를 유형별로 누적해 보여줍니다. 계절별 재난 패턴 파악에 유용합니다. 필터 기간이 한 달 미만이면 일별 데이터로 자동 전환됩니다. 막대/도넛 변형에서 유형을 클릭하면 모든 차트가 해당 유형으로 연동됩니다.",                                                 defaultSpan: 6,  icon: "🪜", variants: [{ key: "donut", label: "도넛" }, { key: "hbar", label: "가로막대" }, { key: "bar", label: "세로막대" }] },
